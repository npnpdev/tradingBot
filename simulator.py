import time
from config import STOP_LOSS_PERCENTAGE, TAKE_PROFIT_PERCENTAGE, SLEEP_TIME_BETWEEN_TRADES, update_wallet, save_trade_result, save_trade_log, get_trade_number
